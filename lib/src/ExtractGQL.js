...
var ExtractGQL = (function () {
    ...
    ExtractGQL.prototype.createMapFromDocument = function (document) {
        ...
        queryDefinitions.forEach(function (transformedDefinition) {
            ...
            result[docQueryKey] = _this.getQueryId(docQueryKey);
        });
        return result;
    };
    ...
    ExtractGQL.prototype.createOutputMapFromString = function (docString) {
        ...
        if (docString.length > 0) {
            ...
            var docMap_1 = graphql_1.separateOperations(doc);
            var resultMaps_1 = Object.keys(docMap_1).map(function (operationName) {
                var document = docMap_1[operationName];
    ...
    ExtractGQL.prototype.getQueryId = function (queryKey) {
        this.queryId += 1;
